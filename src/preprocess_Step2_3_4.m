...
function preprocess_Step2_3_4(fileNameContainingDirPath, fileNameContainingMutProb, numNT, thisGenomicSegStartInd, thisGenomicSegStopInd, FLAGS_preProc_Steps_2_3_4, datadir)
...
%             disp([num2str(thisTP) ' ' num2str(length(freqCountNT))]);
