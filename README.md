...
This repository contains codes for the MPL-R pipeline presented in the manuscript

### Linkage-aware inference of fitness from short-read time-series genomic data  
Syed Muhammad Umer Abdullah <sup>1,2, Muhammad Saqib Sohail<sup>1, Raymond H. Y. Louie<sup>1,3,4,5, John P. Barton<sup>6, and Matthew R. McKay<sup>1,7</sup>\*
