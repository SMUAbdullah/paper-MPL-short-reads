% update: 13-Nov-2020, option to not assign synNonS yn
...
function findIndexingAndMakeCSVFile(dirNameAnalysis, thisFileNameHUFiles, chosenSlash, refSeq, thisGenomicSegStopInd, thisGenomicSegStartInd, freqCountNTAllbSampAllTP, numFileNameHUFilesCell, consensusSeqTP1, numNT, varargin)

if(nargin == 10)
    binaryCoding = true;
    markSynNonSyn = false;
elseif(nargin == 11)
    synNonSyn = varargin{1};
