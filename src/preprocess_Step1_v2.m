...
if(isempty(fileNamesThisPat_inAnalysisDir))
    ...
    for f = 1:numFiles
        ...
        for t = 1:numTimePoints
            ...
            disp(['Time point ' num2str(timePointVec(t)) ', sum of frequencies of all haplotypes: ' num2str(temp1)])
    ...
    disp('aborted.')
    disp('Warning: Exiting without running preprocesing step 1.')
    disp('         Analysis folder already contains fasta files.')
    disp(' ')
    disp('Empty the analysis folder and rerun for preprocessing step 1.')
